...
def fit(epochs, lr, start_idx=1):
    ...
    for epoch in range(epochs):
        for real_images, _ in tqdm(train_dl):
            # Train discriminator
            d_loss, r_score, f_score = train_discriminator(real_images, opt_d)

            # Train generator
            g_loss = train_generator(opt_g)
        ...
        print("Epoch [{}/{}], loss_g: {:.4f}, loss_d: {:.4f}, real_score: {:.4f}, fake_score: {:.4f}".format(
            epoch+1, epochs, g_loss, d_loss, r_score, f_score))
...
plt.plot(epochs_range, losses_g, label='Generator Loss', marker='o', linestyle='-', color='blue')
plt.plot(epochs_range, losses_d, label='Discriminator Loss', marker='x', linestyle='--', color='red')

plt.title("Generator vs Discriminator Losses Over Epochs", fontsize=14)
...
plt.figure(figsize=(10, 5)) 
plt.plot(epochs_range, real_scores, label='Real Scores', marker='o', linestyle='-', color='blue')
plt.plot(epochs_range, fake_scores, label='Fake Scores', marker='x', linestyle='--', color='red')

plt.title("Real and Fake scores", fontsize=14)
plt.xlabel("Epoch", fontsize=12)
